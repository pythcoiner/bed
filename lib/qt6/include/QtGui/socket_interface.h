 ...
 * Command line was: qdbusxml2cpp -i QtGui/private/qspi_struct_marshallers_p.h -p socket_interface.h:socket_interface.cpp /build/source/src/gui/accessible/linux/dbusxml/Socket.xml
 *
...
namespace org {
  namespace a11y {
    namespace atspi {
      using Socket = ::OrgA11yAtspiSocketInterface;
    }
  }
}
#endif
