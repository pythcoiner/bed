...
function(qt_auto_detect_linux_x86)
    if("${QT_QMAKE_TARGET_MKSPEC}" STREQUAL "linux-g++-32" AND NOT QT_NO_AUTO_DETECT_LINUX_X86)
        ...
        #
        # For example to exclude /var/empty/lib/x86_64-linux-gnu/mit-krb5/libgssapi_krb5.so
        # you need to add /var/empty/lib/x86_64-linux-gnu/mit-krb5 explicitly to CMAKE_IGNORE_PATH.
        # Adding just /var/empty/lib/x86_64-linux-gnu to either CMAKE_IGNORE_PATH or
        ...
        #   /var/empty/local/lib/x86_64-linux-gnu/pkgconfig
        #   /var/empty/local/lib/pkgconfig
        #   /var/empty/local/share/pkgconfig
        #   /var/empty/lib/x86_64-linux-gnu/pkgconfig
        #   /var/empty/lib/pkgconfig
        #   /var/empty/share/pkgconfig
        ...
        if(NOT QT_NO_OVERRIDE_CMAKE_IGNORE_PATH)
            set(linux_x86_ignore_path "/var/empty/lib/x86_64-linux-gnu;/lib/x86_64-linux-gnu")
        ...
        if(NOT QT_NO_OVERRIDE_PKG_CONFIG_LIBDIR)
            ...
            list(APPEND pc_config_libdir "/var/empty/local/lib/i386-linux-gnu/pkgconfig")
            list(APPEND pc_config_libdir "/var/empty/local/lib/pkgconfig")
            list(APPEND pc_config_libdir "/var/empty/local/share/pkgconfig")
            list(APPEND pc_config_libdir "/var/empty/lib/i386-linux-gnu/pkgconfig")
            list(APPEND pc_config_libdir "/var/empty/lib/pkgconfig")
            list(APPEND pc_config_libdir "/var/empty/share/pkgconfig")
