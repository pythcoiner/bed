...
function(_qt_internal_find_ios_development_team_id out_var)
    ...
    execute_process(COMMAND "/var/empty/libexec/PlistBuddy"
...
function(_qt_internal_get_apple_sdk_version out_var)
    if(APPLE)
        ...
        execute_process(COMMAND /var/empty/bin/xcrun --sdk ${sdk_name} ${xcrun_version_arg}
...
function(_qt_internal_get_xcode_version_raw out_var)
    if(APPLE)
        execute_process(COMMAND /var/empty/bin/xcrun xcodebuild -version
